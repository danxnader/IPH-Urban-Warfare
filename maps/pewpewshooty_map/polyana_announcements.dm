/datum/map/frontier
	emergency_shuttle_docked_message = "Evacuation Helicopter has landed. You have approximately %ETD% to board the Escape Helicopter."
	emergency_shuttle_leaving_dock = "Evacuation Helicopter has left warzone. Estimate %ETA% until the helicopter lands at %dock_name%."

	emergency_shuttle_called_message = "WARNING: An emergency evacuation has been called. It will arrive in approximately %ETA%"
	emergency_shuttle_called_sound = 'sound/AI/november/warning.ogg'

	emergency_shuttle_recall_message = "The emergency helicopter has been recalled."
