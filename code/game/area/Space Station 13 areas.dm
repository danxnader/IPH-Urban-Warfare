...
//	var/list/lights				// list of all lights on this area
	...
	var/turf/base_turf //The base turf type of the area, which can be used to override the z-level's base turf//The base turf type of the area, which can be used to override the z-level's base turf
