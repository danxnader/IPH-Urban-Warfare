...
/turf/simulated/floor/dirt
	var/trench_stage = 0
/turf/simulated/floor/trench/Enter(atom/movable/O, atom/oldloc)
	if(isliving(O))
		var/mob/living/L = O
		var/message_cooldown
		if(!istype(oldloc, /turf/simulated/floor/trench))
...
/turf/simulated/floor/trench/Exit(atom/movable/O, atom/newloc)
	if(isliving(O))
		var/mob/living/L = O
		var/message_cooldown
		if(!istype(newloc, /turf/simulated/floor/trench))
			if(L.grabbed_by && L.grabbed_by.len)
				var/mob/living/L2 = L.grabbed_by[1].assailant
				visible_message("<span class = 'notice'>[L2] starts pulling [L] out of trench.</span>")
...
/turf/simulated/floor/dirt/attackby(obj/item/C as obj, mob/user as mob)
...
/turf/floor/plating/grass/attackby(obj/item/C as obj, mob/user as mob)
	if (istype(C, /obj/item/weapon/shovel/trench))
		...
		ChangeTurf(/turf/simulated/floor/dirt)
		return
	..()
